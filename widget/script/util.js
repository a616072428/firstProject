...
var formatTimeToHMS = function(time) {
    return new Date(time).format("hh:mm:ss");
};
var formatTimeToHM_ch = function(time){
    return new Date(time).format("yyyy" + "年" + "MM" + "月");
};
var formatTimeToMMDD = function(time){
    return new Date(time).format("MMdd");
};
var formatTimeToMM = function(time){
    return new Date(time).format("MM");
};
var formatTimeToMMDDs = function(time){
    return new Date(time).format("MM/dd");
};
var formatTimeToYY = function(time){
